...
public abstract class Hilt_QuizzesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuizzesFragment() {
    super();
  }

  Hilt_QuizzesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuizzesFragment_GeneratedInjector) this.generatedComponent()).injectQuizzesFragment(UnsafeCasts.<QuizzesFragment>unsafeCast(this));
    }
  }
