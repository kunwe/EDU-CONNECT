...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull ImageView ivLogo, @NonNull TextView tvRegisterLink) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, btnGoogleLogin, btnLogin, etEmail,
          etPassword, ivLogo, tvRegisterLink);
    }
