...
public final class ActivityMainContainerBinding implements ViewBinding {
  ...
  private ActivityMainContainerBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityMainContainerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainContainerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_container, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainContainerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainContainerBinding((ConstraintLayout) rootView, bottomNav,
          navHostFragment);
    }
