...
public abstract class Hilt_SubjectsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SubjectsFragment() {
    super();
  }

  Hilt_SubjectsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SubjectsFragment_GeneratedInjector) this.generatedComponent()).injectSubjectsFragment(UnsafeCasts.<SubjectsFragment>unsafeCast(this));
    }
  }
